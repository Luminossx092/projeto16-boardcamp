...
export async function AddCustomer(req, res) {
    ...
    try {
        ...
        const tabelaCustomers = await db.query("SELECT * FROM customers");
        const insertGame = await db.query(`INSERT INTO customers(id,name,phone,cpf,birthday) VALUES($1,$2,$3,$4,$5)`
            , [tabelaCustomers.rowCount + 1, customer.name, customer.phone, customer.cpf, customer.birthday]);
